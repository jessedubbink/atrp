                ...
                <tbody>
                    @foreach($news as $article)
                        <tr>
                            ...
                            <td class="d-none d-md-table-cell">{{ date("d-M-Y", strtotime($article->created_at)) }}</td>
                            <td class="d-none d-md-table-cell">
                                <div class="btn-group">
                                    <a href="{{ Route('news.edit', $article->id) }}" class="btn btn-info m-1">Edit</a>
                            ...
                            <td class="d-sm-table-cell d-md-none">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton">
                                        <a href="{{ Route('news.edit', $article->id) }}" class="dropdown-item bg-info text-light" type="button">Edit</a>
